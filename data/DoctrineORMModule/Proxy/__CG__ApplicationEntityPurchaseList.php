 ...
 */
class PurchaseList extends \Application\Entity\PurchaseList implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'purchases', 'name', 'startDate', 'endDate', 'users', 'id', 'created', 'lastModified', 'deleted');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PurchaseList $proxy) {
    ...
    public function getPurchases()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPurchases', array());
